...
public class AccountPreferencesFragment extends PreferencesListFragment implements AccountCreatorListener {
	...
	private void initAccountPreferencesFields(PreferenceScreen parent) {
		//Todo: set the proxy, nat_policy and auth_info section dynamically
		int proxySectionNumber = 0;
		int authInfoSectionNumber = 0;
		int natPolicySectionNumber = 0;

		String proxySection = "proxy_" + proxySectionNumber;
		String authInfoSection = "auth_info_" + authInfoSectionNumber;
		String natPolicySection = "nat_policy_" + natPolicySectionNumber;
		...
		disableOrEnablePreference(username, mPrefs.isAccountUsernameRemoteOverwrite(authInfoSection));
		...
		disableOrEnablePreference(userid, mPrefs.isAccountUserIdRemoteOverwrite(authInfoSection));
		...
		disableOrEnablePreference(password, mPrefs.isAccountPasswordRemoteOverwrite(authInfoSection));
		...
		disableOrEnablePreference(domain, mPrefs.isAccountDomainRemoteOverwrite(authInfoSection));
		...
		disableOrEnablePreference(ice, mPrefs.isEnableIceRemoteOverwrite(natPolicySection));
		...
		disableOrEnablePreference(stunTurn, mPrefs.isStunTurnServerRemoteOverwrite(natPolicySection));
		...
		disableOrEnablePreference(mProxyPreference, mPrefs.isProxyRemoteOverwrite(proxySection));
		...
		disableOrEnablePreference(outboundProxy, mPrefs.isOutboundProxyRemoteOverwrite(proxySection));
		...
		disableOrEnablePreference(expires, mPrefs.isRegExpiresRemoteOverwrite(proxySection));
		...
		disableOrEnablePreference(prefix, mPrefs.isDialPrefixRemoteOverwrite(proxySection));
		...
		disableOrEnablePreference(avpf, mPrefs.isAvpfRemoteOverwrite(proxySection));
		...
		disableOrEnablePreference(avpfRRInterval, mPrefs.isAvpfIntervalRemoteOverwrite(proxySection));
		...
		disableOrEnablePreference(escape, mPrefs.isReplacePlusByZeroZeroRemoteOverwrite(proxySection));
		...
		disableOrEnablePreference(pushNotif, mPrefs.isPushNotificationRemoteOverwrite());
    	...
    	disableOrEnablePreference(delete, mPrefs.isAccountDeleteDisabledRemotely());
